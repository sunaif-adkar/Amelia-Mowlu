        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="👨‍💼 Master", url="t.me/sunaif_adkar"),  InlineKeyboardButton(text="Help 🤔", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="🖥️ Tutorial Video🖥️", url="https://youtu.be/wKL90i3cjPw")],
                     [InlineKeyboardButton(text="👥 Any Doubt", url="t.me/sabotschannel"), InlineKeyboardButton(text="MT Updates🤖", url="t.me/sabotschannel")],
                     [InlineKeyboardButton(text="🎬 YT Channel", url="https://youtube.com/channel/UCO2HqhBLZ6G0c_8KAsSQuFA"), InlineKeyboardButton(text="Repo ⛓️", url="https://github.com/sunaif-adkar-Amelia-Mowlu")],
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1249529870 and DONATION_LINK:
